...
.sidebar { width:250px; background:#00a38eff; color:white; display:flex; flex-direction:column; padding:40px 20px; position:sticky; top:0; }
.sidebar .profile { display:flex; flex-direction:column; align-items:center; margin-bottom:50px; }
...
.sidebar .profile p { font-size:0.9rem; color:#e0e0ff; margin-top:10px; }
...
.main-content { flex:1; padding:40px; margin-bottom:80px; }
h1 { text-align:center; color:#333; margin-bottom:30px; }
.stats-cards { display:grid; grid-template-columns:1fr 1fr; gap:30px; }
.card { display:flex; align-items:center; width:100%; min-height:120px; background:#fff; border-radius:15px; box-shadow:0 4px 10px rgba(0,0,0,0.1); padding:15px 20px; transition:all 0.2s ease; cursor:pointer; }
.card:hover { transform:translateY(-3px); box-shadow:0 8px 20px rgba(0,0,0,0.15); }
.card-icon { font-size:2.5rem; margin-right:20px; }
.card-info h3 { margin:0 0 5px 0; color:#6c5ce7; }
.card-info p { font-size:1.2rem; font-weight:bold; margin:0; color:#333; }
.card-info small { display:block; margin:5px 0; color:#555; }
.card-info a { text-decoration:none; color:#6c5ce7; font-weight:bold; margin-top:5px; display:inline-block; }
.card-info a:hover { text-decoration:underline; }
@media (max-width:768px) {
    .page-wrapper { flex-direction:column; }
    .sidebar { width:100%; flex-direction:row; justify-content:space-around; padding:20px; }
    .sidebar .profile h3 { width:50px; height:50px; line-height:50px; font-size:0.9rem; }
